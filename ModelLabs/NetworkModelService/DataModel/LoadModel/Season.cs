...
namespace FTN.Services.NetworkModelService.DataModel.LoadModel
{
    public class Season : IdentifiedObject
    {
        ...
        public override bool Equals(object x)
        {
            ...
            {
                Season s = (Season)x;
                return (s.endDate == this.endDate && s.startDate == this.startDate &&
                    CompareHelper.CompareLists(s.seasonDayTypeSchedules, this.seasonDayTypeSchedules, true));
            }else
            {
                return false;
            }
        ...
        public override bool HasProperty(ModelCode t)
        {
            switch (t)
            {
                ...
                case ModelCode.SEASON_SEASONDTS:
                    return true;
        ...
        public override void GetReferences(Dictionary<ModelCode, List<long>> references, TypeOfReference refType)
        {
            ...
            {
                references[ModelCode.SEASON_SEASONDTS] = seasonDayTypeSchedules.GetRange(0, seasonDayTypeSchedules.Count);
            }
