...
namespace FTN.Services.NetworkModelService.DataModel.LoadModel
{
    public class DayType : IdentifiedObject
    {
        ...
        public override bool Equals(object obj)
        {
            if(base.Equals(obj))
            {
                DayType dt = (DayType)obj;
                return CompareHelper.CompareLists(dt.SeasonDayTypeSchedules, this.seasonDayTypeSchedules, true);
            }else
            {
                return false;
            }
        ...
        public override bool HasProperty(ModelCode t)
        {
            switch (t)
            {
                case ModelCode.DAYTYPE_SEASONDTS:
                    return true;
        ...
        public override void GetReferences(Dictionary<ModelCode, List<long>> references, TypeOfReference refType)
        {
            ...
            {
                references[ModelCode.DAYTYPE_SEASONDTS] = seasonDayTypeSchedules.GetRange(0, seasonDayTypeSchedules.Count);
            }
