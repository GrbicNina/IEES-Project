...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			typeIdsInInsertOrder.Add(ModelCode.REGTIMEPOINT);
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.REGULARINTERVALSCH_TIMEPOINTS);
			notSettablePropertyIds.Add(ModelCode.SEASON_SEASONDTS);
			notSettablePropertyIds.Add(ModelCode.DAYTYPE_SEASONDTS);
