...
namespace Klijent
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            comboBox3.Items.Add("DAYTYPE");
            comboBox3.Items.Add("SEASON");
            comboBox3.Items.Add("REGULARTIMEPOINT");
            comboBox3.Items.Add("BREAKER");
            comboBox3.Items.Add("RECLOSER");
            comboBox3.Items.Add("LOADBREAKSWITCH");
            comboBox3.Items.Add("SWITCHSCHEDULE");

            comboBox2.Items.Add("DAYTYPE");
            comboBox2.Items.Add("SEASON");
            comboBox2.Items.Add("REGULARTIMEPOINT");
            comboBox2.Items.Add("BREAKER");
            comboBox2.Items.Add("RECLOSER");
            comboBox2.Items.Add("LOADBREAKSWITCH");
            comboBox2.Items.Add("SWITCHSCHEDULE");

            comboBox4.Items.Add("DAYTYPE");
            comboBox4.Items.Add("SEASON");
            comboBox4.Items.Add("REGULARTIMEPOINT");
            comboBox4.Items.Add("BREAKER");
            comboBox4.Items.Add("RECLOSER");
            comboBox4.Items.Add("LOADBREAKSWITCH");
            comboBox4.Items.Add("SWITCHSCHEDULE");
        }
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "DAYTYPE":
                    lista_getVal = gda.GetExtentValues(ModelCode.DAYTYPE);
                    break;
                case "SEASON":
                    lista_getVal = gda.GetExtentValues(ModelCode.SEASON);
                    break;
                case "REGULARTIMEPOINT":
                    lista_getVal = gda.GetExtentValues(ModelCode.REGTIMEPOINT);
                    break;
                case "BREAKER":
                    lista_getVal = gda.GetExtentValues(ModelCode.BREAKER);
                    break;
                case "RECLOSER":
                    lista_getVal = gda.GetExtentValues(ModelCode.RECLOSER);
                    break;
                case "LOADBREAKSWITCH":
                    lista_getVal = gda.GetExtentValues(ModelCode.LOADBREAKSWITCH);
                    break;
                case "SWITCHSCHEDULE":
                    lista_getVal = gda.GetExtentValues(ModelCode.SWITCHSCHEDULE);
                    break;
            }
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (comboBox2.SelectedItem.ToString())
                {
                case "DAYTYPE":
                    lista_getExVal = gda.GetExtentValues(ModelCode.DAYTYPE);
                    break;
                case "SEASON":
                    lista_getExVal = gda.GetExtentValues(ModelCode.SEASON);
                    break;
                case "REGULARTIMEPOINT":
                    lista_getExVal = gda.GetExtentValues(ModelCode.REGTIMEPOINT);
                    break;
                case "BREAKER":
                    lista_getExVal = gda.GetExtentValues(ModelCode.BREAKER);
                    break;
                case "RECLOSER":
                    lista_getExVal = gda.GetExtentValues(ModelCode.RECLOSER);
                    break;
                case "LOADBREAKSWITCH":
                    lista_getExVal = gda.GetExtentValues(ModelCode.LOADBREAKSWITCH);
                    break;
                case "SWITCHSCHEDULE":
                    lista_getExVal = gda.GetExtentValues(ModelCode.SWITCHSCHEDULE);
                    break;
            }
        ...
        private void comboBox4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "DAYTYPE":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.DAYTYPE);
                    break;
                case "SEASON":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.SEASON);
                    break;
                case "REGULARTIMEPOINT":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.REGTIMEPOINT);
                    break;
                case "BREAKER":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.BREAKER);
                    break;
                case "RECLOSER":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.RECLOSER);
                    break;
                case "LOADBREAKSWITCH":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.LOADBREAKSWITCH);
                    break;
                case "SWITCHSCHEDULE":
                    lista_getRelVal = gda.GetExtentValues(ModelCode.SWITCHSCHEDULE);
                    break;
            }
